            ...
            SettingSection(
                ...
                tiles: [
                  SettingSwitchTile(
                    ...
                    title: Text("foggy_layout".tr()),
                    toggled: PreferencesHelper.getBool("foggyLayout") ?? false,
                    onChanged: (value) {
                      setState(() {
                  ...
                  if (PreferencesHelper.getBool("foggyLayout") == false)
                    SettingActionTile(
                      icon: Icon(
                        Symbols.image,
                        fill: 1,
                      ...
                      title: Text("background_images".tr()),
                      onTap: () {},
                    ),
                  SettingSwitchTile(
